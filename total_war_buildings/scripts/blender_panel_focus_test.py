...
def main():
    addon_utils.enable("total_war_buildings", default_set=True, persistent=True)
    from total_war_buildings.ui import panels
    ...
    from total_war_buildings.ui.collection_utils import get_active_collection
    ...
    from total_war_buildings.ui.collection_utils import find_piece_collection
